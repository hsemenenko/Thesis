...
\makechapterstyle{daleifmodif}{
	...
	\renewcommand\printchaptertitle[1]{\if@mainmatter\ifdraftdoc\color{gray}\else\color{white}\fi\chaptitlefont\raggedleft ##1\par\newpage{\thispagestyle{empty}}\nopagecolor~\newpage\else\color{gray}\chaptitlefont\raggedleft ##1\par\fi}
} 
\makeatother 
