...
\newcommand\feline@chapter@marker[1][4cm]{%
	\sbox\feline@chapter{% 
		\resizebox{!}{#1}{\fboxsep=1pt%
			{\ifdraftdoc\color{gray}\else\color{gray}\fi\thechapter}% 
			}
		}%
		\quad%
...
\makechapterstyle{daleifmodif}{
	...
	\renewcommand\printchapternum{\thispagestyle{empty}\ifdraftdoc\else\pagecolor{white}\fi\null\hfill\feline@chm[2.5cm]\par} 
	...
	\renewcommand{\mempostaddchaptertotochook}{
									...
									\begin{figure*}
										\centering
									\includegraphics[scale=0.25]{./graphics/skytale_draft}
									\end{figure*}	
									\clearpage
									\nopagecolor
...
\usepackage[pdfpagelayout=TwoColumnRight,			%Makes pdf two page scrolling
			pagebackref,
