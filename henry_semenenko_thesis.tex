...
\documentclass[a4paper,11pt,reqno,openbib,oldfontcommands]{memoir} %add 'draft' to turn draft option on (see below)
%
...
\usepackage[square,numbers,sort]{natbib}		%Calls bibliography commands
...
%\usepackage{pgfplots}
%\usepgfplotslibrary{external} 		%enable externalisation
%\tikzext ernalize		       		%exable externalisation. Also need to add "--shell-escape" switch to the command line
...
%\addbibresource{./build/thesisbiblio.bib}	
