...
%Cycle colours
\definecolor{cycle1}{HTML}{ab1f2d}
\definecolor{cycle2}{HTML}{a01a35}
\definecolor{cycle3}{HTML}{94143d}
\definecolor{cycle4}{HTML}{890f44}
\definecolor{cycle5}{HTML}{7d0a4b}
\definecolor{cycle6}{HTML}{700552}
\definecolor{cycle7}{HTML}{620359}
\definecolor{cycle8}{HTML}{53025f}
\definecolor{cycle9}{HTML}{420266}
\definecolor{cycle10}{HTML}{2a036d}
...
\usepackage{etoolbox}				%Package to change theorem style boxes
\usepackage{changepage}				%Package to change theorem style boxes

% Hide page numbers for chapters in toc
%\usepackage{tocloft}
...
%New cycle list
\pgfplotscreateplotcyclelist{redpurple}{%
	{cycle1, mark = none, thick},
	{cycle2, mark = none, thick},
	{cycle3, mark = none, thick},
	{cycle4, mark = none, thick},
	{cycle5, mark = none, thick},
	{cycle6, mark = none, thick},
	{cycle7, mark = none, thick},
	{cycle8, mark = none, thick},
	{cycle9, mark = none, thick},
	{cycle10, mark = none, thick}
}
...
%        colormap={RdYlGn-reversed}{
%            indices of colormap=(
%                \pgfplotscolormaplastindexof{RdYlGn},...,0 of RdYlGn
%            )
%        },
%        % ... which then is mapped to a `cycle list'
%        cycle list/.define={RdYlGn-reversed}{[of colormap=RdYlGn-reversed]},
%    }
...
%%% GLOSSARIES STUFF %%%
	\usepackage[acronym,toc,symbols,section,nogroupskip,shortcuts=ac]{glossaries-extra}
	...
	\renewcommand*{\glslinkpresetkeys}{%
 		\ifnum\GlsXtrLinkCounterValue{\glslabel}>0
...
%%% Define hyperref as last package %%%
...
\bibliography{./build/thesisbiblio}
