...
\makechapterstyle{daleifmodif}{
	...
	\renewcommand\printchapternum{\thispagestyle{empty}\pagecolor{bristol-red}\null\hfill\feline@chm[2.5cm]\par} 
	\renewcommand\afterchapternum{\par\vspace{25pt}\vskip\midchapskip} 
	\renewcommand\printchaptertitle[1]{\if@mainmatter\color{white}\chaptitlefont\raggedleft ##1\par\newpage{\thispagestyle{empty}}\nopagecolor~\newpage\else\color{gray}\chaptitlefont\raggedleft ##1\par\fi}
} 
\makeatother 
