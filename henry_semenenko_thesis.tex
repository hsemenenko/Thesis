...
\makechapterstyle{daleifmodif}{
	...
	\renewcommand\printchaptertitle[1]{
		\if@mainmatter
			...
			\begin{figure*}
				\centering
				\includegraphics[scale=0.35]{./logos/bristollogo_white_small}
			\end{figure*}				
		\else
...
\makeevenhead{myvf}{\small\textsc{\rightmark}}{}{} 
\makeoddhead{myvf}{}{}{\small\textsc{\leftmark}}
\pagestyle{myvf}
%
...
\newcommand{\clearemptydoublepage}{\clearpage{\thispagestyle{empty}}~\newpage{\thispagestyle{empty}\cleardoublepage}\glsresetall}
%
%
...
\DeclareGraphicsExtensions{.eps,.pdf,.png,.jpg,.ps}
\epstopdfDeclareGraphicsRule{.ps}{pdf}{.pdf}{eps2pdf -dEPSCrop -dNOSAFER #1 \OutputFile}		
