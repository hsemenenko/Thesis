...
\begin{itemize}
	...
	\item \brisred{Chapter 5} explores new \acp{pic} for \ac{QKD} by using the ever-advancing integrated photonics platform. New methods of generating quantum states will be discussed. We will also introduce new integrated circuits that will simplify the electronics required for operation. We will show how photonic chips become devices through optical and electrical connections, as well as discussing the challenges. 
