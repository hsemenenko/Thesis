...
\begin{equation}
	a^\dagger_e \xrightarrow{BS} \frac{1}{\sqrt{2}} (a^\dagger_e + b^\dagger_e) \xrightarrow{aMZI} \frac{1}{\sqrt{2}} (a^\dagger_l + b^\dagger_e) \xrightarrow{BS} \frac{1}{2}(a^\dagger_e + a^\dagger_l - b^\dagger_e + b^\dagger_l)
\end{equation}

$\ket{-}$:

\begin{equation}
	b^\dagger_e \xrightarrow{BS} \frac{1}{\sqrt{2}} (a^\dagger_e - b^\dagger_e) \xrightarrow{aMZI} \frac{1}{\sqrt{2}} (a^\dagger_l - b^\dagger_e) \xrightarrow{BS} \frac{1}{2}(- a^\dagger_e + a^\dagger_l + b^\dagger_e + b^\dagger_l)
\end{equation}
