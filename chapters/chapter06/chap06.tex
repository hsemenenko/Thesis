...
\begin{align}
	\ket{0} = a^\dagger_e, \quad \ket{1} = a^\dagger_l, \quad \ket{+} = \frac{1}{\sqrt{2}}(a^\dagger_e + a^\dagger_l),  \quad \text{and} \quad \ket{-} = \frac{1}{\sqrt{2}}(a^\dagger_e - a^\dagger_l)
\end{align}
