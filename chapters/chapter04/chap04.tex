...
\begin{figure}[t]
	...
	\caption[Picture of the specialised FPGA controller for integrated QKD]{Picture of the specialised \ac{fpga} controller for integrated QKD. Can provide RF and DC signals for driving the chips.}
	\label{fig:fpga}
\end{figure}
