...
\begin{figure}[tbp]
	\centering
	\includegraphics[width = \textwidth]{Electrical_Signals/plot.png}
	\caption[Electrical signals for BB84 states]{Oscilloscope data of the electrical signals required for the BB84 states. }
