...
\end{tabular}
\caption[Measurement outcomes in MDI-QKD]{Post-selection rules of measurement outcomes in different bases. If Alice and Bob sent states in the same basis, either Alice of Bob of them will have to flip their bit unless the both chose the X basis and the result was $\ket{\psi^+}$.}
...
\end{equation}
in a time bin encoding where $e$ and $l$ refer to early and late time-bins of the state. This states are shown in figure \ref{fig:bell_state_projections}.
