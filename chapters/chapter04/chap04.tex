...
This model doesn't take into account detection saturation effects, increased probability of $\ket{\psi^+}$ or losses induced through the optical network for detector banking.
