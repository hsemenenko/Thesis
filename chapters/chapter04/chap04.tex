...
\begin{sidewaysfigure}
	...
	\caption[Latest generation InP QKD Transmitter]{There are many ways of improving the QKD transmitters. For example, encoding in time-bin using a delay line to separate the pulses or generating different states using independent lasers.}
\end{sidewaysfigure}
