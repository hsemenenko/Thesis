...
Cryptography is the process of taking a message (\brisred{plaintext}) and translating it into a something that is indecipherable (\brisred{ciphertext}). Importantly, cryptography also encompasses the reverse process of taking a ciphertext and returning the original message. 
...
Since then, there have been numerous demonstrations that \ac{QKD} system are insecure under real world condition. These have demonstrated vulnerabilities in all parts of both the transmitters and receivers: transmitter modulation \cite{Gisin2006}, detectors \cite{Lydersen2010,Makarov2006}. 
