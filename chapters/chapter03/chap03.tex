...
\begin{align}
	...
	=&  \text{D}_c(\alpha r + \beta t)\otimes\text{D}_d(\alpha t - \beta r)\ket{0,0}_{c,d}
\end{align}

For a 50:50 beam splitter, the output would become

\begin{equation}
	\text{D}_c\left(\frac{1}{\sqrt{2}}\big(i\alpha + \beta\big)\right)\otimes\text{D}_d\left(\frac{1}{\sqrt{2}}\big(\alpha - i\beta\big)\right)\ket{0,0}_{c,d}
\end{equation}
