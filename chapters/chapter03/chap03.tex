...
\begin{figure}
	...
	\caption[On-chip DBR laser]{Integrated laser formed of two DBRs and an SOA.}
	\label{fig:InP_laser}
\end{figure}
...
\begin{figure}[tbp]
	...
	\caption[On-chip laser spectra]{Typical spectra of the two independent on-chip lasers. Each demonstrates a \ac{FWHM} of \SI{30}{pm} which is limited to the precision of the optical spectrum analyser used. The two lasers are deliberately detuned so that both can be seen. }
	\label{fig:spectra}
\end{figure}
...
\begin{figure}[tbp]
	...
	\caption[Integrated Mach-Zehnder interferometer]{Integrated \acl{mzi} made from two \acsp{mmi} and two \acsp{eopm}  which can be used for intensity modulation of light into pulses.}
	\label{fig:InP_MZI}
\end{figure}
