...
\begin{figure}[t]
	...
	\import{chapters/chapter03/fig03/}{ph_rand_coins.pdf_tex}
...
%By looking at coincidences between neighbouring pulses we can check correlations between \acp{wcp} that didn't interfere. If the laser is phase randomised, we would not expect to see any relation between subsequent pulses. 
