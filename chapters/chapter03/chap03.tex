...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=\textwidth]{gain_switch.pdf}
...
\begin{figure}[tbp]
	...
	\caption[HOM interference with and without phase randomisation]{\ac{HOM} interference both with and without phase randomisation between pulses. In both cases we find a fitted visibility of more than $47\%$ showing that phase randomisation doesn't reduce the fidelity of the states.}
